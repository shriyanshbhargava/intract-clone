		...
		<Disclosure as="div" className="p-6 relative" defaultOpen={false}>
			<DisclosureButton className="group flex items-center justify-between">
				...
				<div className="flex flex-col text-left ml-[15px] backdrop-filter backdrop-blur-[5px]">
					<div className="text-[23px] font-normal leading-[30px] mb-[8px]">{title}</div>
					<div className="text-[16px] font-normal leading-[20px] mb-[16px] overflow-hidden opacity-50">
						{description}
					</div>
					<hr
					...
					{tasks && tasks.map((task, index) => (
						...
						>
							<div className="flex-[0_0_120px] h-[80px]">
								<img src={task.imageSrc} alt="" className="object-cover w-full h-full rounded-[12px]" />
							</div>
