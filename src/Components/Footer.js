...
import { BiLogoTwitter, BiLogoDiscord, BiLogoTelegram, BiLogoSpotify } from 'react-icons/bi';
		...
		<div className="opacity-1">
			<div className="max-w-[1200px] mx-auto p-4 lg:p-[2em]">
				<div className="flex flex-col lg:flex-row justify-between items-start lg:pr-[120px]">
					<a href="/" className="max-w-[300px] gap-y-[18px] flex-col items-start flex mb-4 lg:mb-0">
						<div>
							<a className="float-left text-[#333] no-underline relative" href="/">
					...
					<div className="flex flex-wrap gap-8 lg:gap-x-[60px]">
						...
						<FooterColumn title="About">
							<FooterLink href="https://docs.intract.io" target="_blank">
								Product Roadmap
							</FooterLink>
							<FooterLink
							...
							<FooterLink href="https://docs.intract.io/for-business/sign-up-program" target="_blank">
								Sign up Program
							</FooterLink>
							<FooterLink href="https://forms.gle/tdjCuL1HJ1EzhQpq8" target="_blank">
								Growth Community
							</FooterLink>
						...
						<FooterColumn title="Support">
							...
							<FooterLink href="https://app.intract.io" target="_blank">
								Create your quest
							</FooterLink>
							<FooterLink
...
const FooterColumn = ({ title, children }) => (
	<div className="gap-y-[10px] flex-col justify-start items-start flex">
		<div className="tracking-[0] uppercase font-normal leading-[1.2]">{title}</div>
		{children}
	</div>
);
...
const FooterIcon = ({ icon }) => <div className="bg-gray-900 rounded pointer p-2">{icon}</div>;
